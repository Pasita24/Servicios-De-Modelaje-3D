...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xffffb3b6),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff844045),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff8f4a4e),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff75353a),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xfffed6a1),
      onTertiary: Color(0xff362100),
      tertiaryContainer: Color(0xffad8b5c),
      ...
      primaryFixedDim: Color(0xffffb3b6),
      onPrimaryFixedVariant: Color(0xff5e2328),
      secondaryFixed: Color(0xffffdada),
